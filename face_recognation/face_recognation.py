...
Original file is located at
    https://colab.research.google.com/drive/1Ryq_9bqHu7ZOmJlValKJnhdhjO8hDFcj

# Face Recognation using PCA
...
targets = df["target"] # define output as targets
pixels = df.drop(["target"],axis=1) # define input as pixels
